      ...
      <form>
        ...
        <div class="columnas">
          <div class="form-group">
            ...
            <input type="text" name="ciu" class="form-control" id="ciu">
          </div>
        ...
        <div class="columnas">
          ...
          <div class="form-group">
            ...
            <input type="text" name="bar" class="form-control" id="bar">
          </div>
        </div>
        <div class="columnas">
        <div class="form-group">
...
<br><br>
  ...
  <button class="primary-button" type="button" value="ENVIAR" class="btn btn-success" name="btn_enviar" onclick="guardar();"> ENVIAR
  </button>
</div>
<br>
<div class="button-borders">
  <button class="primary-button" type="button" value="CANCELAR" class="btn btn-danger" name="btn_cancelar" onclick="limpiar();"> LIMPIAR
  </button>
</div>
        </center>
    ...
    $.ajax(
    {
      ...
      success:  function (valores) 
      {
        if(valores.existe=="1") //Aqui usamos la variable que NO use en el vídeo
        {
          ...
          $("#ciu").val(valores.ciudad);
          $("#com").val(valores.comentarios);
          $("#nit").val(valores.nit);
          $("#bar").val(valores.barrio);
          $("#cor").val(valores.correo);
        }
        else
        {
