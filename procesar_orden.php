    ...
    for ($i = 0; $i < $total_productos; $i++) {
        ...
        if ($result_producto->num_rows > 0) {
            ...
            if ($cantidad_en_inventario >= $cantidad_actual) {
                ...
                $sql_insert_orden = "INSERT INTO ordenes (id, codigo_cliente, fecha, nombre_cliente, observacion,correciones) VALUES ('$id', '$codigo_cliente', '$fecha', '$nombre_cliente', '$observacion', '$correciones')";
